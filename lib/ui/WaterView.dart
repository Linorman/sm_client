// ignore_for_file: file_names, library_private_types_in_public_api, prefer_const_literals_to_create_immutables, prefer_const_constructors
...
import 'package:client/ui/WaveView.dart';
                                  ...
                                  Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          '最后一次检查 ${DateTime.now().hour.toString().padLeft(2, '0')}:${DateTime.now().minute.toString().padLeft(2, '0')}:${DateTime.now().second.toString().padLeft(2, '0')}',
                                          textAlign: TextAlign.center,
                                          style: TextStyle(
                                            fontFamily: HomePageTheme.fontName,
                                            fontWeight: FontWeight.w500,
                      ...
                      SizedBox(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            // Container(
                            //   decoration: BoxDecoration(
                            //     color: HomePageTheme.nearlyWhite,
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: <BoxShadow>[
                              BoxShadow(
                                  color: HomePageTheme.grey.withOpacity(0.4),
                                  offset: const Offset(2, 2),
                                  blurRadius: 4),
                            ],
                          ),
                          child: WaveView(
                            percentageValue: water,
                          ),
                        ),
                      )
                    ],
