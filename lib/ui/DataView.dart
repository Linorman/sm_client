// ignore_for_file: file_names, non_constant_identifier_names, prefer_final_fields, must_be_immutable, use_key_in_widget_constructors, library_private_types_in_public_api, no_logic_in_create_state, camel_case_types
...
class DataView extends StatefulWidget {
  const DataView(Key key, this.animation, this.animationController)
      : super(key: key);
  final AnimationController? animationController;
  final Animation<double>? animation;
  // const DataView_(this.animation, this.animationController);
  @override
...
class DataViewState extends State<DataView> {
  ...
  //final GlobalKey<PartRefreshWidgetState> globalKey;
  DataViewState({this.animationController, this.animation});
                                                ...
                                                Padding(
                                                  padding:
                                                      const EdgeInsets.only(
                                                          left: 4, bottom: 3),
                                                  child: Text(
                                                    '${(lux * animation!.value).toInt()}', // TODO:burned num
                                                    textAlign: TextAlign.center,
                                                    style: const TextStyle(
                                                      fontFamily: HomePageTheme
                                                          .fontName,
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Text(
                                            '${(1503 * animation!.value).toInt()}', // 剩余num
                                            textAlign: TextAlign.center,
                                            style: const TextStyle(
                                              fontFamily:
                                                  HomePageTheme.fontName,
