...
class HistoryView extends StatefulWidget {
  String friend;
  HistoryView(this.friend, this.animation, this.animationController, {super.key});
  final AnimationController? animationController;
  final Animation<double>? animation;
  // const HistoryView_(this.animation, this.animationController);
  @override
  HistoryViewState createState() => HistoryViewState(friend: friend,
...
class HistoryViewState extends State<HistoryView> {
  ...
  HistoryViewState({required this.friend, this.animationController, this.animation});
